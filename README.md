...
- **story-flows** — Turns questions like "what happens when a user signs up?" into user-story-inspired flow cards with acceptance notes, graph playback, and hidden `spoken_text` for optional read-aloud playback.
