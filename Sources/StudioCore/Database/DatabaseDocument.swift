...
public enum DatabaseDocument {
    ...
    public static let supportedExtensions = sqliteExtensions.union(otherExtensions).union(["sgreview", "sgpreview", "sgexplanation", "sql"])
    public static let supportedFormatsDescription = [
        ...
        "Schema scripts: .sql",
        "Saved historical explanations: .sgexplanation"
    ].joined(separator: "\n")
